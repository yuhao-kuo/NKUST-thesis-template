...
\def\thesispowerofattorney{Externals/powerofattorney.pdf}   % 博碩士論文授權書
\def\thesisvalidation{Externals/sign.pdf}                   % 論文口試委員會審定書
\def\thesisphdrecommand{Externals/recommand.pdf}            % 博士論文推薦書
