...
\def\cosupervisortwname{李時珍 博士}  % 共同指導教授中文名字
\def\cosupervisorenname{Shi-Zhen Li Ph.D.}  % 共同指導教授英文名字
\provideboolean{multiplesupervisor}
\setboolean{multiplesupervisor}{false} % 是否有共同指導教授,true: 兩位指導教授, false: 一位指導教授
